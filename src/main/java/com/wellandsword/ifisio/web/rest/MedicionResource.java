...
public class MedicionResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new medicion, or with status {@code 400 (Bad Request)} if the medicion has already an ID.
    ...
    public ResponseEntity<Medicion> createMedicion(@RequestBody Medicion medicion) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/medicions/" + result.getId()))
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated medicion,
     * or with status {@code 400 (Bad Request)} if the medicion is not valid,
     * or with status {@code 500 (Internal Server Error)} if the medicion couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<Medicion> updateMedicion(@RequestBody Medicion medicion) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, medicion.getId().toString()))
            .body(result);
    }
     ...
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of medicions in body.
     */
    @GetMapping("/medicions")
    public List<Medicion> getAllMedicions() {
        log.debug("REST request to get all Medicions");
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the medicion, or with status {@code 404 (Not Found)}.
     */
